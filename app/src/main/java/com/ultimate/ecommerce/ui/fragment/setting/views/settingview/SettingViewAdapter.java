...
public class SettingViewAdapter extends RecyclerView.Adapter<SettingViewHolder> {
    ...
    private void addSettingItems(Context context) {
        list.add(getSettingModel(context, ORDERS, R.string.orders, R.drawable.ic_orders));
        list.add(getSettingModel(context, ADDRESS, R.string.orders, R.drawable.ic_address_street));
        list.add(getSettingModel(context, FAVORITE, R.string.orders, R.drawable.ic_favourite));
        list.add(getSettingModel(context, LANG_CUR, R.string.orders, R.drawable.ic_language_currency));
        list.add(getSettingModel(context, HELP, R.string.orders, R.drawable.ic_help));
        list.add(getSettingModel(context, ABOUT, R.string.orders, R.drawable.ic_about));
        list.add(getSettingModel(context, CONTACT_US, R.string.orders, R.drawable.ic_contact));
        list.add(getSettingModel(context, LOGOUT, R.string.orders, R.drawable.ic_logo));
    }
    ...
    public SettingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.view_setting, null, false);
