...
public class MinSliderTowViewHolder extends RecyclerView.ViewHolder {
    Banner data;
    MinSliderTowViewListener listener;
    ViewBannerBinding binding;


    public MinSliderTowViewHolder(@NonNull View itemView, MinSliderTowViewListener listener) {
        super(itemView);
